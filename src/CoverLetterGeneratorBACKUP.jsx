...
{ phrase: '—', suggestion: 'Em dashes are a major AI tell — replace with a comma or rewrite the sentence' },
];
...
10. Do NOT use em dashes (—) anywhere in the letter. Use commas, periods, or rewrite the sentence instead.
