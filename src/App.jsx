...
import { Heart, MessageCircle, Sparkles, Phone, TrendingUp, Briefcase, Users, ChevronRight, Menu, X, BookOpen, Search, ExternalLink, Building, DollarSign, HelpCircle, Phone, ChevronDown, ChevronUp, Edit2, Trash2, FileText, Target, ArrowLeft, Newspaper, Smile, Instagram, Facebook } from 'lucide-react';
...
const supportItems = [
  ...
  { page: 'crisis', label: 'In Crisis Right Now', icon: < className="w-4 h-4" /> },
];
