...
const EncouragementBox = () => {
  ...
  return (
    <>
    <Helmet>
  <title>Free Resume Builder for College Students | MoreThanOneWay.org</title>
  <meta name="description" content="Build a resume that gets noticed. Free resume builder for college students and new grads — step-by-step guidance, templates, and AI-powered feedback." />
  <meta name="keywords" content="free resume builder college students, student resume template, how to write a resume, resume help new grad, AI resume review" />
  <meta property="og:title" content="Free Resume Builder | MoreThanOneWay.org" />
  <meta property="og:description" content="Build a resume that gets noticed — free resume builder with step-by-step guidance for college students." />
</Helmet>
