  ...
  <div className="flex items-start gap-3">
    ...
    <div>
      ...
      <p className="text-xs text-red-600 italic">
        You matter. This feeling is temporary. People want to help. â¤ï¸
      </p>
    </div>
  </div>
</div>
...
useEffect(() => {
  ...
  return (
    <nav className={`nav-gradient text-white shadow-lg sticky top-0 z-50 header ${scrolled ? 'scrolled' : ''}`}>
  ...
  <button onClick={() => setCurrentPage('crisis')} className="bg-red-500 px-4 py-2 rounded hover:bg-red-600 whitespace-nowrap">Need Help Now?</button>
          ...
          {/* Mobile Navigation */}
       {mobileMenuOpen && (
  <div className="absolute top-full left-0 right-0 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 md:hidden pb-4 space-y-2 px-4">
...
export default function App() {
  ...
  if (currentPage === 'search-guide') {
    return <SearchGuide onBack={() => setCurrentPage('home')} setCurrentPage={setCurrentPage} />;
  }
