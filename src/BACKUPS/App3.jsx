...
// Handle major selection
  ...
  <p className="font-semibold text-blue-800 mb-2">ðŸ“… Timing Matters!</p>
  ...
  {/* Research Section */}
            <div className="bg-green-50 border-2 border-green-200 rounded-lg shadow-lg p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                ðŸ“Š Research Before You Apply
              </h2>
              <p className="text-gray-700 mb-4">
                Once you find opportunities that interest you, spend 10 minutes researching each company. This helps you:
              </p>
              <ul className="text-gray-700 space-y-2 mb-6">
                <li>âœ“ Avoid toxic workplaces and bad intern experiences</li>
                <li>âœ“ Write targeted, personalized applications</li>
                <li>âœ“ Prepare better for interviews</li>
                <li>âœ“ Know what salary and benefits to expect</li>
              </ul>
            ...
            >
                ...
                <div className="bg-white p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-700">
                    â€¢ Visit the company's career page to learn about their internship program<br/>
                    â€¢ Check recent company news to mention in your application
                  </p>
                </div>
              </div>
            </div>
