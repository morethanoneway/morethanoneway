...
const extractKeywords = (text) => {
  if (!text) return [];
  const stopWords = new Set(['description','looking','people','innovation','success','joining','secure','world','advance','ensure','ensures','connect','protect','customers','inventive','electrical','solutions','organization','opportunities','opportunity','program','programs','through','provide','provides','provided','during','within','across','between','without','around','global','local','national','international','company','companies','position','positions','candidate','candidates','applicant','applicants','employee','employees','employer','unique','talent','talents','impact','making','impactful','strides','today','bright','ambition','vision','sustainable','empower','welcome','cultivate','ideas','personal','professional','skills','formal','informal','training','leadership','variety','projects','experiences','learned','courses','others','involved','designing','manufacturing','optimizing','systems','plants','facilities','around','currently','recruiting','start','fall','spring','assignments','include','generating','conducting','studies','participating','manufacture','perform','research','development','activities','conduct','testing','troubleshooting','participate','improvement','position','beyond','daily','addition','support','manager','expect','through','exposure','engaging','networking','career','professionals','invited','special','events','volunteer','throughout','promote','inclusion','respect','embrace','diversity','network','peers','managers','senior','leaders','growth','competitive','hourly','relocation','housing','eligible','receive','toward','outstanding','performance','offered','subsequent','fulltime','pursuing','bachelor','desire','least','sophomore','later','graduating','written','communication','ability','interface','multiple','functional','areas','leading','provider','believe','enable','safer','design','market','install','service','comprehensive','range','recognized','quality','reliability','principal','office','london','management','minneapolis','robust','portfolio','brands','dates','includes','encourage','support','philanthropic','worldwide','matching','nonprofit','educational','donate','values','culture','deliver','known','innovative','adaptable','dedicated','absolute','integrity','focused','customer','respectful','oriented','optimistic','energizing','accountable','people','health','wellbeing','broad','package','meaningful','eligible','dental','vision','plans','along','flexible','spending','accounts','short','term','long','disability','benefits','critical','illness','accident','insurance','retirement','purchase','match','supplemental','tuition','reimbursement','caregiver','parental','leave','backup','services','celebrate','authenticity','understand','uniqueness','sparks','the','a','an','and','or','but','in','on','at','to','for','of','with','by','from','is','are','was','were','be','been','have','has','had','do','does','did','will','would','could','should','may','might','can','that','this','these','those','it','its','we','our','you','your','they','their','i','my','me','as','if','when','which','who','what','how','all','any','both','each','more','most','other','some','into','through','before','after','about','while','also','than','very','just','not','no','nor','so','yet','either','whether','must','shall','need']);
