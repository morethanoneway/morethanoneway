...
>
  ...
  <p className="mt-4 text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl">
    Hating your major is more common than you think — and it doesn’t mean you’re stuck. It usually means you’re paying attention.
  </p>
</header>
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button onClick={() => setCurrentPage('pivot')} className="bg-gray-900 text-white px-6 py-4 rounded-2xl font-semibold hover:bg-gray-700 transition-all text-center text-sm">
                Explore Career Paths by Major →
              </button>
              <button onClick={() => navigate('/career-services-no-idea')} className="bg-white border border-gray-200 text-gray-900 px-6 py-4 rounded-2xl font-semibold hover:bg-gray-50 transition-all text-center text-sm shadow-sm">
...
<div className="mt-12 bg-white rounded-3xl border border-gray-200 shadow-sm p-8 md:p-10 text-center">
  <div className="mx-auto w-12 h-12 rounded-2xl bg-yellow-50 flex items-center justify-center mb-4">
    <BookOpen className="w-6 h-6 text-yellow-600" />
  </div>

  <h3 className="text-2xl font-bold text-gray-900 mb-3">
    Hating your major is information, not failure.
  </h3>

  <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed mb-6">
    It means you're paying attention. Use that information to find something that actually fits.
  </p>
